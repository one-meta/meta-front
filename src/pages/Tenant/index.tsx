...
import {
  ...
  getTenant,
  postTenant,
  postTenantBulk__openAPI__delete,
  putTenantId,
} from '@/services/meta/Tenant';
...
const IndexPage: React.FC = () => {
  ...
  //多行选择
  const [selectedRowsState, setSelectedRows] = useState<API.Tenant[]>([]);
  ...
  const columns: ProColumns<API.Tenant>[] = [
    ...tenantColumns,
    {
      ...
      render: (_text, record) => [
        ...
        //详情（跳转页面）
        // TODO：根据需求修改路径
        // <LinkLayout key="link" to={`/permission/project/detail/${record.id}`} />,
        // //查看
        // <ShowRowDetailLayout
        //   key="view"
  ...
  return (
    <ProTableLayout
      ...
      //Service 方法
      getMethod={getTenant}
      editMethod={putTenantId}
      newMethod={postTenant}
      deleteBulkMethod={postTenantBulk__openAPI__delete}
